...
!
    ...
    !
       IF (wfo) THEN
          ...
          ELSE
             WRITE(lout,910) IRANK,(i,i=0,nb_trs+1,2)
          END IF
          call mexPrintf(lout//char(10))
    ...
    IF (wfo) THEN
       ...
       END DO
          ...
          ELSE
             ...
             ELSE
               WRITE(lout,222) IRANK,nddl,npc,      &
               ((((save_trs(i2)+save_trs(i2+1))*100)/i1),i2=1,nb_trs,2)  &
               ,9999999,i1*100/(n-nddl)
            END IF
          END IF
    ENDIF
    call mexPrintf(lout//char(10))
